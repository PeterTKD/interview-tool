...
if not st.session_state.setup_complete:
    ...
    st.session_state["experience"] = st.text_area(label = "Expirience", value = st.session_state["experience"], height = None, placeholder = "Describe your experience",  max_chars = 200)
